Shader "ShaderSamples/TerrainCircle"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        {
            float2 uv_MainTex;
			float3 worldPos; // the inworld position
        };
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
			...
			//if for the current pixel, the distance is within the
			//circle range then color it red.
